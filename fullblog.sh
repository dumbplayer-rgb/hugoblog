...
sourcePath="/home/max/daytoday/posts/"
destinationPath="/home/max/Documents/blog/my-blog/content/posts/"
...
if [ ! -f "imagesinker.py" ]; then
    echo "Python script imagesinker.py not found."
    exit 1
fi

if ! python3 imagesinker.py; then
